...
THEMES = {
    # name: (foreground, dim-foreground, default-background)
    "dark": ("#F59E0B", "#4a3010", "#0C0F14"),
    "light": ("#3E4551", "#b9bfc7", "#F4F5F7"),
}
...
def main(argv=None):
    ...
    for theme in themes:
        ...
        # per-theme background: explicit --bg always wins; otherwise fall
        # back to this theme's locked default instead of the other theme's
        # background leaking across (the original bug).
        theme_bg = args.bg if args.bg else THEMES[theme][2]
        original_bg = args.bg
        args.bg = theme_bg
